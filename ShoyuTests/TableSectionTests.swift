...
class TableSectionTests: XCTestCase {
    ...
    func testAddSingleRow() {
        let section = TableSection().addRow(Row())
    ...
    func testCreateSingleRow() {
        let section = TableSection() { section in
    ...
    func testCreateHeaderGeneric() {
        let section = TableSection() { (section: TableSection<UILabel, UIButton>) in
    ...
    func testConfigureHeaderFooterHeight() {
        ...
        // Initialized
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), nil)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), nil)
        ...
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), 10)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), 11)
        ...
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), 20)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), 21)
        ...
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), 30)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.heightFor(UITableView(), section: 0), 31)
    }
    ...
    func testConfigureHeaderFooterTitle() {
        ...
        // Initialized
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.titleFor(UITableView(), section: 0), nil)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.titleFor(UITableView(), section: 0), nil)
        ...
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.titleFor(UITableView(), section: 0), constantHeaderTitle)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.titleFor(UITableView(), section: 0), constantFooterTitle)
        ...
        XCTAssertEqual((section.header as? TableSectionHeaderFooterDelegateType)?.titleFor(UITableView(), section: 0), variableHeaderTitle)
        XCTAssertEqual((section.footer as? TableSectionHeaderFooterDelegateType)?.titleFor(UITableView(), section: 0), variableFooterTitle)
